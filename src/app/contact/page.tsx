            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-bricolage-text">Mumbai</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-bricolage-text">Email: abhishekbanerji04@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-bricolage-text">Phone: +91 98209 98042</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-bricolage-text">WhatsApp: +91 98209 98042</p>
                  </div>
                </div>
              </div>
            </div>
