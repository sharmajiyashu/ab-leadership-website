      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <SectionHeading
            ...
            subtitle="Creative arts–informed therapeutic programs designed to support emotional processing, regulation, and recovery for individuals in psychiatric care"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {programs.slice(0, 3).map((program) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-lg font-bold text-gray-800 mb-3 font-bricolage-display">
                    {program.title}
                  </h3>
                  {program.techniques && (
