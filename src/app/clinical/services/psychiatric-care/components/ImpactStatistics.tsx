  ...
  return (
    <section ref={sectionRef} className="py-16 bg-slate-800">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          {/* Fact 1 - 65% emotional regulation */}
          <div className="group relative overflow-hidden bg-gradient-to-r from-slate-50 to-indigo-100 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 transform">
            ...
            <div className="relative z-10 font-bricolage-text">
              <div className="mb-6">
                <AnimatedNumber target={65} suffix="%" delay={0} />
                <div className="w-20 h-1 bg-blue-600 rounded-full mt-1.5 animate-[slideIn_1.2s_ease-out]" />
              </div>
              <p className="text-gray-900 text-lg leading-relaxed mb-4">
                Up to{" "}
                <span className="font-bold">
                  65% of participants show improved emotional regulation
                </span>{" "}
                when expressive or body-based therapies are added to treatment.
              </p>
              <div className="flex items-center text-sm text-gray-700 mt-6">
                <span className="italic">NIH-indexed clinical studies</span>
              </div>
            </div>
          ...
          <div className="group relative overflow-hidden bg-gradient-to-r from-slate-50 to-purple-100 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 transform">
            ...
            <div className="relative z-10 font-bricolage-text">
              <div className="mb-6">
                <AnimatedNumber target={50} suffix="%" delay={400} />
                <div className="w-20 h-1 bg-indigo-600 rounded-full mt-1.5 animate-[slideIn_1.4s_ease-out]" />
              </div>
              <p className="text-gray-900 text-lg leading-relaxed mb-4">
                Up to{" "}
                <span className="font-bold">50% higher treatment engagement</span>{" "}
                among individuals with severe mental illness when therapy
                includes movement, art, music, or drama.
              </p>
              <div className="flex items-center text-sm text-gray-700 mt-6">
                <span className="italic">
                  WHO mental health service evaluations
                </span>
              </div>
            </div>
          ...
          {/* Fact 3 - 65% hope & future orientation */}
          <div className="group relative overflow-hidden bg-gradient-to-r from-slate-50 to-violet-100 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 transform">
            ...
            <div className="relative z-10 font-bricolage-text">
              <div className="mb-6">
                <AnimatedNumber target={65} suffix="%" delay={600} />
                <div className="w-20 h-1 bg-purple-600 rounded-full mt-1.5 animate-[slideIn_1.6s_ease-out]" />
              </div>
              <p className="text-gray-900 text-lg leading-relaxed mb-4">
                <span className="font-bold">65% of service users</span> report
                improved hope and future orientation when therapy includes
                storytelling, music, or creative meaning-making.
              </p>
              <div className="flex items-center text-sm text-gray-700 mt-6">
                <span className="italic">WHO Recovery Framework</span>
              </div>
            </div>
