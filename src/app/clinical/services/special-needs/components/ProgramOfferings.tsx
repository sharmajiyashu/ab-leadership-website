      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <SectionHeading
            ...
            subtitle="Creative arts–informed therapeutic programs designed to support learning, communication, emotional regulation, and social connection for children with special needs"
          >
        ...
        <div>
          ...
          {/* Second row - 2 additional program cards */}
