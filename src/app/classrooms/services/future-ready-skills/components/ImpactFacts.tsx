...
const AnimatedNumber = ({ target, suffix = "", duration = 2000, delay = 0 }: { target: number; suffix?: string; duration?: number; delay?: number }) => {
  ...
  return (
    <div ref={ref} className="text-4xl md:text-5xl font-bricolage-display font-semibold text-gray-900 mb-2">
...
const cardBackgrounds = {
  1: {
    ...
    circle: 'bg-indigo-200/40',
    waves: 'text-indigo-300/80',
  },
  2: {
    gradient: 'from-slate-50 to-purple-100',
    circle: 'bg-purple-200/40',
    waves: 'text-purple-300/80',
  },
  3: {
    gradient: 'from-slate-50 to-violet-100',
    circle: 'bg-violet-200/40',
    waves: 'text-violet-300/80',
  },
} as const;
...
const CardBackgroundDecoration = ({ variant }: { variant: 1 | 2 | 3 }) => {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-[1]" aria-hidden>
      ...
      <svg
        className={`absolute bottom-5 right-3 w-28 h-14 md:w-32 md:h-16 ${bg.waves}`}
        viewBox="0 0 128 64"
        fill="none"
      >
        ...
        >
          ...
          <div className="group relative overflow-hidden bg-gradient-to-r from-slate-50 to-indigo-100 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 transform">
            ...
            <div className="relative z-10 font-bricolage-text">
              <div className="mb-6">
                <AnimatedNumber target={75} suffix="%" delay={0} />
                <div className="w-20 h-1 bg-blue-600 rounded-full mt-1.5 animate-[slideIn_1.2s_ease-out]" />
              </div>
              <p className="text-gray-900 text-lg leading-relaxed mb-4">
                75% of employers say they struggle to find candidates with the right soft and life skills, even when technical qualifications are present.
              </p>
          ...
          <div className="group relative overflow-hidden bg-gradient-to-r from-slate-50 to-purple-100 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 transform">
            ...
            <div className="relative z-10 font-bricolage-text">
              <div className="mb-6">
                <AnimatedNumber target={44} suffix="%" delay={400} />
                <div className="w-20 h-1 bg-indigo-600 rounded-full mt-1.5 animate-[slideIn_1.4s_ease-out]" />
              </div>
              <p className="text-gray-900 text-lg leading-relaxed mb-4">
                Only 44% of graduates globally are considered &quot;job-ready&quot; by employers, highlighting a significant gap between education and workplace expectations.
              </p>
              <p className="text-gray-700 text-sm italic">
          ...
          <div className="group relative overflow-hidden bg-gradient-to-r from-slate-50 to-violet-100 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 transform">
            ...
            <div className="relative z-10 font-bricolage-text">
              <div className="mb-6">
                <AnimatedNumber target={85} suffix="%" delay={600} />
                <div className="w-20 h-1 bg-purple-600 rounded-full mt-1.5 animate-[slideIn_1.6s_ease-out]" />
              </div>
              <p className="text-gray-900 text-lg leading-relaxed mb-4">
                85% of jobs that will exist in 2030 have not been invented yet, making adaptability and transferable skills more critical than static knowledge.
              </p>
              <p className="text-gray-700 text-sm italic">
