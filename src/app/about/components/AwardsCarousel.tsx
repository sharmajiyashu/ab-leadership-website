...
const DEFAULT_AWARD_IMAGES = [
  ...
  '/aboutMe/awards/3.JPG',
  '/aboutMe/awards/4.jpg',
  '/aboutMe/awards/5.jpg',
  '/aboutMe/awards/5 pifa.jpg',
  '/aboutMe/awards/6 lions.jpg',
  '/aboutMe/awards/7.jpg',
  '/aboutMe/awards/8 awesumeer.jpg',
  '/aboutMe/awards/9.jpg',
  '/aboutMe/awards/9 guest.jpg',
  '/aboutMe/awards/10.jpg',
  '/aboutMe/awards/13 dy.JPG',
  '/aboutMe/awards/14 powai.jpg',
  '/aboutMe/awards/15 GLT.jpg',
  '/aboutMe/awards/34.jpg',
  '/aboutMe/awards/80.jpg',
  '/aboutMe/awards/PE0C8841.JPG',
...
export default function AwardsCarousel({ images }: AwardsCarouselProps) {
  ...
  // Autoplay: opposite direction from Media carousel (strip moves right / slides enter from left)
  useEffect(() => {
    if (isPaused) return;
    ...
    <section className="py-16 overflow-hidden">
                ...
                {extendedImages.map((image, index) => (
                  ...
                  >
                    ...
                    >
                      <Image
                        src={image}
                        alt={`Award ${getOriginalIndex(index) + 1}`}
                        fill
      ...
      {mounted && selectedImage !== null && createPortal(
        ...
        >
          ...
          >
            <Image
              src={awardImages[selectedImage]}
              alt={`Award ${selectedImage + 1}`}
              width={1600}
              height={1200}
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              setSelectedImage((selectedImage - 1 + awardImages.length) % awardImages.length);
            }}
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              setSelectedImage((selectedImage + 1) % awardImages.length);
            }}
