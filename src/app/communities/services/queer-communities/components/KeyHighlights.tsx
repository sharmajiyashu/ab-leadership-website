      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <SectionHeading
            ...
            subtitle="Queer-affirmative, trauma-informed programs designed to support identity, healing, and authentic self-expression through creative and embodied modalities"
          >
