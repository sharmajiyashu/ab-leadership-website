      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <SectionHeading
            ...
            subtitle="Gentle, person-centred creative programs designed to support emotional wellbeing, cognitive vitality, and meaningful social connection"
          >
        ...
        <div>
          ...
          {/* Third row - 1 centered program (same grid so card matches row 1 & 2 size) */}
          {programs.length > 6 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              {programs.slice(6, 7).map((program) => (
                <div
                  key={program.id}
                  className="bg-white rounded-lg shadow-md transition-all duration-300 overflow-hidden cursor-default hover:shadow-lg hover:transform hover:scale-102 md:col-start-1 lg:col-start-2"
                >
                    <div className="relative w-full aspect-[3/2] overflow-hidden">
                      <Image
                        src={program.image || ''}
