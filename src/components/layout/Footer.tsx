  ...
  return (
    <footer ref={sectionRef} className="relative text-white py-16 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url("/home/hero/footer/WhatsApp Image 2026-01-26 at 11.21.51.jpeg")',
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              >
                <h3 className="text-2xl font-bold mb-4">Abhishek Banerji</h3>
                <p className="text-white mb-6 leading-relaxed">
                  Transforming wellbeing and leadership through human-centred, strengths-based practice. Working across clinics, classrooms, corporates, and communities. Focused on practical impact, inclusive design, and sustainable change.
                </p>
                <div className="flex space-x-4">
                  {/* Social Links */}
                  <a 
                    href="https://www.linkedin.com/in/theabhishekbanerji/" 
                  ...
                  <a 
                    href="https://www.instagram.com/theabhishekbanerji" 
                    className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-gray-600 transition-colors duration-300"
                  ...
                  <a 
                    href="mailto:abhishekbanerji04@gmail.com"
                    className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-gray-600 transition-colors duration-300"
                    aria-label="Email"
                  >
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white">abhishekbanerji04@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <a href="https://wa.me/919820998042" className="text-white hover:text-white transition-colors duration-300">+91 98209 98042</a>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-gray-700 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-white text-sm mb-4 md:mb-0">
                © {new Date().getFullYear()} Abhishek Banerji. All rights reserved.
              </div>
